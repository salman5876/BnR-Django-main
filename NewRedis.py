...
def newredis():
    ...
    # Categories
    for f in catID:
        cache.delete('categorycache_for_' + str(f) + '1-1-1undefinedundefined-1undefinedundefined')
        cache_key = 'categorycache_for_' + str(f) + '1-1-1undefinedundefined-1undefinedundefined'
        ...
        cache.set(cache_key,{'results':temp,'items':item,'Pages':totalpages}, cache_time)
    print('done')
