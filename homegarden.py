...
def HomeandGradden_Walmart(request, categoryId, nextpage=0):
        ...
        for category in listCatagories:
            ...
            for item in totalItems:
                ...
                if serializer1.is_valid():
                    ...
                    print serializer1.errors
time.sleep(30)
EbayAPI().ebayHomeGradenAll({})
time.sleep(30)

# bestbuy().getJewelry({})

listCatagories = ['1072864']
for category in listCatagories:
    time.sleep(30)
    HomeandGradden_Walmart({}, category)
time.sleep(30)
...
class MyCronJob(CronJobBase):
    ...
    code = 'homegarden.my_cron_job'    # a unique code
