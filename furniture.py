...
#or "Electronics/Computers/Laptop Computers" in product.category_path
#4044_539095_5547362
def Furniture_Walmart(request, categoryId, nextpage=0):
            ...
            try:
                ...
                if (product.available_online == True) and (product.sale_price != None):
                    ...
                    if product.model_number != None and laptops[product.model_number] == None:
                        ...
                        request["SNR_SubCategory"] = "Furniture"
    ...
    if nextpage != None:
        time.sleep(0.15)
        Furniture_Walmart(request, categoryId, nextpage)
        ...
        for category in listCatagories:
            ...
            for item in totalItems:
                ...
                if serializer1.is_valid():
                    ...
                    print("bad json")
                    print serializer1.errors
bestbuy().getFurniture({})

listCatagories = ['4044_539095_5547362']
for category in listCatagories:
    time.sleep(30)
    Furniture_Walmart({}, category)
time.sleep(30)

time.sleep(30)
EbayAPI().ebayFurnitureAll({})
time.sleep(30)
...
class MyCronJob(CronJobBase):
    ...
    code = 'furnitures.my_cron_job'    # a unique code
