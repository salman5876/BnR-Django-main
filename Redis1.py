...
def redisfunclive():
    ...
    try:
        for i in catID:
            try:
                cache.delete('categorycache_for_django'+str(i)+'1-1-1undefinedundefined-1undefined')
                path='https://backend.shopnroar.com/products/categoryByID2/'+str(i)+'?count=40&low=undefined&high=undefined&brand=undefined&merchant=undefined&sub=undefined&page=1&sort=undefined'
    ...
    try:
        for i in catID:
            try:
                cache.delete('categorycache_for_newfilter_django' + str(i))
